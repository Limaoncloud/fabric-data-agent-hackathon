...
| `NB_Review_And_Score_Data_Agent.ipynb` | Review answers, sources, paraphrases, and generated query logic; calculate the deterministic 24-point score |
...
For the optional Step 5 routing extension, run the notebook separately with `DATASET_NAME = "routing"`. Do not merge those results into the six-question score.
...
The maximum is 24 points for the baseline and 24 points for the final snapshot.
