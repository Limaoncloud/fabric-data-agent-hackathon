...
These tests validate the legal profile against the CSV headers, generated semantic-model and Ontology definitions, notebook metadata, parameter defaults, and Python syntax.
