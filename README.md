...
Default example domain is UK legal Customer 360, but the package can be adapted to other industries using the skills.

## Who This Is For

- Hackathon organizers who need a repeatable Fabric Data Agent demo and hackthon data
- Solution architects demonstrating best practices impact
- Teams learning how to productionize Fabric data agent quality step by step
...
| Facilitator reusing for a different industry | [REUSE_FOR_NEW_INDUSTRY.md](REUSE_FOR_NEW_INDUSTRY.md) | Generate a new dataset and supporting workshop assets for a different industry |
